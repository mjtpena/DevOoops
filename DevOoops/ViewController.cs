    ...
    public partial class ViewController : NSViewController
    {
        ...
        partial void SettingsButtonClick(NSObject sender)         {             var current = NSApplication.SharedApplication.CurrentEvent; 
            ...
            if (!isLoginItem)
            {
                ...
                script = "tell application \"System Events\"\n make new login item at end of login items with properties {name: \"DevOoops\", path:\"/Applications/DevOoops.app\", hidden:false}\n end tell";
